...
// Cosmos DB for case persistence
resource cosmosAccount 'Microsoft.DocumentDB/databaseAccounts@2024-05-15' = {
  name: 'cosmos-voicelab-${resourceToken}'
  location: location
  tags: tags
...
resource containerAppCosmosDbDataContributorRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(resourceGroup().id, voicelab.name, '00000000-0000-0000-0000-000000000002')
  scope: cosmosAccount
  properties: {
    principalId: voicelabIdentity.outputs.principalId
    principalType: 'ServicePrincipal'
